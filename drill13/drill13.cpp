...
void pic(int x, int y,string pict) //placing the 200x200 pictures
{
...
void moving(int x, int y,string pict) //placing the 100x100 pictures
{
...
pict(3,0,"definietlynotshrek.jpg");
foursquare(3,0);
pict(0,6,"definietlynotshrek.jpg");
foursquare(0,6);
pict(6,0,"definietlynotshrek.jpg");
foursquare(6,0);
